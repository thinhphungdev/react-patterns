...
const Usage = () => {
  ...
  return (
    <div style={{ width: '100%' }}>
      <MediumClap onClap={handleClap} className={userCustomeStyles.clap}>
        <MediumClap.Icon className={userCustomeStyles.icon} />
        <MediumClap.Count className={userCustomeStyles.count} />
        <MediumClap.Total className={userCustomeStyles.total} />
      </MediumClap>
